...
<body>
    <div class="container">
        <h4>Relatório Financeiro: {{ $title }}</h4>
        ...
        <table>
            <thead>
                <tr>
                    <th>Banca</th>
                    <th>Depósito Pix</th>
                    <th>Recarga Manual</th>
                    <th>Pagamento Prêmios</th>
                    <th>Pagamento de Bônus</th>
                    <th>Valor Líquido</th>
                </tr>
            </thead>
            <tbody>
        ...
        <!-- Totais -->
        <div class="total">
            <p>Total Pix: R$ {{ $totalPix }}</p>
            <p>Total Recarga Manual: R$ {{ $totalRecargaManual }}</p>
            <p>Total Pag Prêmios: R$ {{ $totalPagPremios }}</p>
            <p>Total Pag. Bônus: R$ {{ $totalPagBonus }}</p>
            <p>Total Valor Líquido: R$ {{ $totalValorLiquido }}</p>
        </div>
    </div>
</body>
</html>
